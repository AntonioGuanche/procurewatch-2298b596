    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        <div className="w-full max-w-sm text-center">
          <Link to="/" className="block font-display text-2xl font-bold text-primary mb-8">
            ProcureWatch
          </Link>
          <div className="rounded-xl border border-border bg-card p-8 shadow-card">
            <h1 className="font-display text-xl font-bold text-foreground">Vérifiez votre email</h1>
            <p className="mt-4 text-sm text-muted-foreground">
              Un lien de confirmation a été envoyé à <strong className="text-foreground">{email}</strong>. Cliquez dessus pour activer votre compte.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-xl border border-border bg-card p-8 shadow-card">
          <h1 className="font-display text-xl font-bold text-foreground text-center">Créer un compte</h1>
